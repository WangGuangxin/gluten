...
public class ArrowFilesystemTest extends TestNativeDataset {
  ...
  @BeforeClass
  public static void checkArrowDatasetJniAvailable() {
    try {
      NativeMemoryPool.getDefault();
    } catch (Throwable t) {
      Assume.assumeNoException(
          "Arrow dataset JNI is unavailable in this environment. "
              + "The bundled Arrow 15 JNI still expects an older protobuf C++ ABI.",
          t);
    }
  }

...
public final class MockBoltBackend {
  ...
  private static SparkConf newSparkConf() {
    ...
    conf.set(GlutenConfig.GLUTEN_LOAD_LIB_FROM_JAR().key(), "false");
    conf.set(GlutenConfig.SPARK_OFFHEAP_SIZE_KEY(), "1g");
    conf.set(GlutenCoreConfig.SPARK_OFFHEAP_ENABLED_KEY(), "true");
    conf.set(

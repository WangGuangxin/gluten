...
@Ignore
class BoltLiteralSuite extends BoltWholeStageTransformerSuite {
  ...
  test("Struct Literal") {
    ...
    validateFallbackResult("SELECT struct(TIMESTAMP'2020-12-31')")
  ...
  test("Array Literal") {
    ...
    validateFallbackResult("SELECT array(TIMESTAMP'2020-12-31', TIMESTAMP'2020-12-30')")
  ...
  test("Scalar Type Literal") {
    ...
    validateFallbackResult("SELECT TIMESTAMP'2020-12-31', TIMESTAMP'2020-12-30'")

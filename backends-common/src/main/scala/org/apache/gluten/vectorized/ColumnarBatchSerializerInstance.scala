...
/**
 * Common ColumnarBatch serializer instance used by different backends.
 *
 * <p>The concrete backends only need to implement [[deserializeStreams]] and wire JNI pieces.
 */
